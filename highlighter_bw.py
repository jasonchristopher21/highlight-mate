    ...
    for val in matched_values:
        ...
        for word in matching_val_area:
            if val in word[4]:
                ...
                if color == 1:
                    # print("this set")
                    highlight.set_colors({"stroke":(0.95,0.95,0.95),"fill":None})
                elif color == 2:
                    highlight.set_colors({"stroke":(0.87,0.87,0.87),"fill":None})
                elif color == 3:
                    highlight.set_colors(colors=fitz.utils.getColor('pink'))
                else:
                    highlight.set_colors({"stroke": (0.85, 0.85, 0.85), "fill": None})
